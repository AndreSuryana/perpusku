                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div style="background-color: #344581 !important;" class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="collapse show" id="collapseDataPegawai" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form action="../../resources/admin/tambah-data-pegawai.php" method="POST" name="form-tambah-data-pegawai">
                                    <div class="form-group">
                                        <label class="small mb-1" for="inputNamaPegawai">Nama Pegawai</label>
                                        <input class="form-control py-4" id="inputNamaPegawai" name="nama_pegawai" type="text" placeholder="Ketik nama pegawai" />
                                    </div>
                                    <div class="form-group">
                                        <label class="small mb-1" for="inputUsername">Username</label>
                                        <input class="form-control py-4" id="inputUsername" name="username" type="text" placeholder="Ketik username" />
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control py-4" id="inputEmail" name="email" type="text" placeholder="Ketik email" />
                                    </div> 
                                    <div class="form-group">
