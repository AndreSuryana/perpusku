            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Kelola Data Pegawai</h1>
                        ...
                        <div class="card mb-4">
                            ...
                            <form action="kelola-data-pegawai.php" method="get" class="d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-3 my-2 my-md-0">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="tabelKelolaPegawai" width="100%" cellspacing="0">
                                        <thead>
                                            <tr>
                                                <th>
                                                    ID
                                        ...
                                        $sql = "SELECT id_pegawai, username, nama_pegawai, role FROM pegawai WHERE nama_pegawai LIKE('%".$search."%') ORDER BY ".$orderBy." ".$sortBy;
                                        ...
                                        while ($data = mysqli_fetch_assoc($result)) {
                                            ...
                                            if ($data['username'] == $_SESSION['username']) {
                                                ...
                                                <td>".$data['role']."</td>
                                                <td class='kelola-data-pegawai'>
                                                    <a href='./edit-data-pegawai.php?id_pegawai=$data[id_pegawai]' class='btn btn-success'><i class='fas fa-edit'></i></a>
                                                    <form style='display: inline' action='../../resources/admin/hapus-data-pegawai.php' method='post'>
                                                        <input type='hidden' name='id_pegawai' value='$data[id_pegawai]'>
                                                        <input type='hidden' name='username value='$data[username]'>
                                                        <input type='hidden' name='role' value='$data[role]'>
                                                        <button class='btn btn-danger' type='submit' name='delete' value='Delete' disabled><i class='far fa-trash-alt'></i></button>
                                                    </form>
                                                </td></tr>";
                                            }
                                            else {
                                                ...
                                                <td class='kelola-data-pegawai'>
                                                    ...
                                                    <form style='display: inline' action='../../resources/admin/hapus-data-pegawai.php' method='post'>
                                                        ...
                                                        <input type='hidden' name='username value='$data[username]'>
                                                        <input type='hidden' name='role' value='$data[role]'>
                                                        <button class='btn btn-danger' type='submit' name='delete' value='Delete'><i class='far fa-trash-alt'></i></button>
                                                    </form>
                                                </td></tr>";
                                            }
                                        }
