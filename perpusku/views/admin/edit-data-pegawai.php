                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <?php 
                                    ...
                                    echo "<strong>$edit[nama_pegawai]</strong>"; 
                
                                ?>
                            </div>
                            <div class="card-body">
                            <form action="../../resources/admin/edit-data-pegawai.php" method="POST" name="form-edit-data-pegawai">
                                    <div class="form-group">
                                        <label class="small mb-1" for="inputID">ID</label>
                                        <input class="form-control py-4" id="inputNamaPegawai" name="id_pegawai" type="text" value="<?php echo $edit['id_pegawai'] ?>" placeholder="Ketik nama pegawai" readonly="readonly" />
                                    </div>
                                    <div class="form-group">
                                        <label class="small mb-1" for="inputNamaPegawai">Nama Pegawai</label>
                                        <input class="form-control py-4" id="inputNamaPegawai" name="nama_pegawai" type="text" value="<?php echo $edit['nama_pegawai'] ?>" placeholder="Ketik nama pegawai" />
                                    </div>
                                    <div class="form-group">
                                        <label class="small mb-1" for="inputUsername">Username</label>
                                        <input class="form-control py-4" id="inputUsername" name="username" type="text" value="<?php echo $edit['username'] ?>" placeholder="Ketik username" />
                                    </div>
                                    <div class="form-group">
                                        <label class="small mb-1" for="inputPassword">Password</label>
                                        <input class="form-control py-4" id="inputPassword" name="password" type="password" placeholder="Ketik password" />
                                    </div>
                                    <div class="form-group">
                                        <label class="small mb-1" for="inputRePassword">Re-enter Password</label>
                                        <input class="form-control py-4" id="inputRePassword" name="re_password" type="password" placeholder="Ketik ulang password" />
                                    </div>
                                    <div class="form-group">
                                        <label class="small mb-1" for="inputRole">Role</label>
                                        <select style="overflow: scroll;" class="form-control" id="inputRole" name="role">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control py-4" id="inputEmail" name="email" type="text" value="<?php echo $edit['email'] ?>" placeholder="Ketik email" />
                                    </div> 
                                    <div class="form-group">
                                        <label class="small mb-1" for="inputNIK">NIK</label>
                                        <input class="form-control py-4" id="inputNIK" name="nik" type="text" value="<?php echo $edit['nik'] ?>" placeholder="Ketik NIK" />
                                    </div>     
                                    <div class="form-group">
                                        <label class="small mb-1" for="inputAlamat">Alamat</label>
                                        <input class="form-control py-4" id="inputAlamat" name="alamat" type="text" value="<?php echo $edit['alamat'] ?>" placeholder="Ketik alamat" />
                                    </div> 
                                    <div class="form-group">
                                        <label class="small mb-1" for="inputNoTelp">No. Telp</label>
                                        <input class="form-control py-4" id="inputNoTelp" name="no_telp" type="text" value="<?php echo $edit['no_telp'] ?>" placeholder="Ketik no telp" />
                                    </div>   
