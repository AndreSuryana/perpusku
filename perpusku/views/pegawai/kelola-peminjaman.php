                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="tablePeminjaman" width="100%" cellspacing="0">
                                        <thead>
                                            <tr>
                                                <th>
                                                    ID
                                                    <a href="<?php $_SERVER['PHP_SELF'] ?> ?order=id_peminjaman&sort=asc">
                                                    <i style="color: #404040; float: right; margin: 0px 4px 0px 4px" class="fa fa-arrow-up"></i></a>
                                                    <a href="<?php $_SERVER['PHP_SELF'] ?> ?order=id_peminjaman&sort=desc">
                                                ...
                                                <th>
                                                    Tanggal Pinjam
                                                    <a href="<?php $_SERVER['PHP_SELF'] ?> ?order=tanggal_pinjam&sort=asc">
                                                    <i style="color: #404040; float: right; margin: 0px 4px 0px 4px" class="fa fa-arrow-up"></i></a>
                                                    <a href="<?php $_SERVER['PHP_SELF'] ?> ?order=tanggal_pinjam&sort=desc">
                                                    <i style="color: #404040; float: right; margin: 0px 4px 0px 4px;" class="fa fa-arrow-down"></i></a>
                                                </th>
                                                <th>
                                                    Tanggal Kembali
                                                    <a href="<?php $_SERVER['PHP_SELF'] ?> ?order=tanggal_kembali&sort=asc">
                                                    <i style="color: #404040; float: right; margin: 0px 4px 0px 4px" class="fa fa-arrow-up"></i></a>
                                                    <a href="<?php $_SERVER['PHP_SELF'] ?> ?order=tanggal_kembali&sort=desc">
                                                    <i style="color: #404040; float: right; margin: 0px 4px 0px 4px;" class="fa fa-arrow-down"></i></a>
                                                </th>
                                                <th>
                                                    Dikembalikan
                                                    <a href="<?php $_SERVER['PHP_SELF'] ?> ?order=status_dikembalikan&sort=asc">
                                                    <i style="color: #404040; float: right; margin: 0px 4px 0px 4px" class="fa fa-arrow-up"></i></a>
                                                    <a href="<?php $_SERVER['PHP_SELF'] ?> ?order=status_dikembalikan&sort=desc">
                                                    <i style="color: #404040; float: right; margin: 0px 4px 0px 4px;" class="fa fa-arrow-down"></i></a>
                                                </th>
                                                <th>
                                        ...
                                        if ($_GET['sort'] == 'asc') {
                                            ...
                                            $sortBy = 'ASC';
                                            if ($_GET['order'] == 'id_peminjaman') $orderBy = 'id_peminjaman';
                                            ...
                                            else if ($_GET['order'] == 'tanggal_pinjam') $orderBy = 'tanggal_pinjam';
                                            else if ($_GET['order'] == 'tanggal_kembali') $orderBy = 'tanggal_kembali';
                                            else if ($_GET['order'] == 'status_dikembalikan') $orderBy = 'status_dikembalikan';
                                            else $orderBy = 'id_peminjaman';
                                        }
                                        ...
                                        $sql = "SELECT * FROM tabelPeminjaman WHERE nama_peminjam LIKE('%".$search."%') ORDER BY ".$orderBy." ".$sortBy;
                                        ...
                                        while ($data = mysqli_fetch_assoc($result)) {
                                            ...
                                            if ($data['status_dikembalikan'] == 'sudah') {
                                                ...
                                                <td>".ucfirst($data['status_dikembalikan'])."</td>
                                                <td class='kelola-peminjaman'>
                                                    <form style='display: inline' action='../../resources/pegawai/approve-pengembalian-buku.php' method='post'>
