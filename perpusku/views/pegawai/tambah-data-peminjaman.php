                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form action="../../resources/pegawai/tambah-data-peminjaman.php" method="POST" name="form-tambah-data-peminjaman">
                                    <div class="form-group">
                                        <label class="small mb-1" for="inputPeminjam">Peminjam</label>
                                        <select style="overflow: scroll;" class="form-control" id="inputPeminjam" name="peminjam">
                                            ...
                                            $peminjam = mysqli_query($conn, $sql);

                                            while ($data_peminjam = mysqli_fetch_assoc($peminjam)) {
                                                
                                                echo "<option value=".$data_peminjam['id_peminjam'].">".$data_peminjam['nama_peminjam']."</option>";
                                            }      
                                    ...
                                    <div class="form-group">
                                        <label class="small mb-1" for="inputBuku">Pilih Buku</label>
                                        <select style="overflow: scroll;" class="form-control" id="inputBuku" name="isbn_buku">
                                            ...
                                            $sql = "CALL showJudulBukuInStock()";
                                            $buku = mysqli_query($conn, $sql);

                                            while ($data_buku = mysqli_fetch_assoc($buku)) {
                                                
                                                echo "<option value=".$data_buku['isbn_buku'].">".$data_buku['judul']."</option>";
                                            }      
                                    ...
                                    <div class="form-group">
                                        <label class="small mb-1" for="inputTanggalPinjam">Tanggal Pinjam</label>
                                        <input class="form-control py-4" id="inputTanggalPinjam" name="tanggal_pinjam" type="text" placeholder="dd-mm-yyyy">
                                    </div>
                                    <div class="form-group">
                                        <label class="small mb-1" for="inputTanggalKembali">Tanggal Kembali</label>
                                        <input class="form-control py-4" id="inputTanggalKembali" name="tanggal_kembali" type="text" placeholder="dd-mm-yyyy">
                                    </div>
                                    <div class="form-group mt-4 mb-0">
                                        <button class="btn btn-primary btn-block" type="submit" name="Submit" value="Submit">Selesai</button>
                                    </div>
                                </form>
                            </div>
                        </div>
