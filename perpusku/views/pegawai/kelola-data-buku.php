                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div style="background-color: #344581 !important;" class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="collapse show" id="collapseKelolaBuku" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Kelola Data Buku</h1>
                        <ol style="background-color: white !important;" class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="./dashboard.php">Dashboard</a></li>
                            <li class="breadcrumb-item active">Kelola Data Buku</li>
                        </ol>
                        <div class="card mb-4">
                            ...
                            <form action="kelola-data-buku.php" method="get" class="d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-3 my-2 my-md-0">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="tableBuku" width="100%" cellspacing="0">
                                        ...
                                        $sql = "SELECT * FROM showAllDataBukuAktif WHERE judul LIKE('%".$search."%') ORDER BY ".$orderBy." ".$sortBy;
                                        ...
                                        while ($data = mysqli_fetch_assoc($result)) {
                                            ...
                                            <td>".$data['judul']."</td>
                                            <td class='kelola-data-buku'>
                                                <a href='./edit-data-buku.php?isbn_buku=$data[isbn_buku]' class='btn btn-success'><i class='fas fa-edit'></i></a>
                                                <form style='display: inline' action='../../resources/pegawai/hapus-data-buku.php' method='post'>
                                                    <input type='hidden' name='isbn_buku' value='$data[isbn_buku]'>
