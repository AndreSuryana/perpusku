                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <?php 
                                    ...
                                    // $sql = "CALL getJudul('$_GET[isbn_buku]')";
                                    $sql = "SELECT * FROM buku WHERE isbn_buku = '$_GET[isbn_buku]'";
                                    $result = mysqli_query($conn, $sql);

                                    $edit = mysqli_fetch_assoc($result);

                                    echo "<strong>$edit[judul]</strong>"; 
                
                                ?>
                            </div>
                            <div class="card-body">
                                <form action="../../resources/pegawai/edit-data-buku.php" method="POST" name="form-tambah-data-buku">
                                    <div class="form-group">
                                        
                                        <label class="small mb-1" for="inputISBN">ISBN Buku *isbn buku tidak dapat diubah</label>
                                        <input class="form-control py-4" id="inputISBN" name="isbn_buku" type="number" value="<?php echo $edit['isbn_buku'] ?>" readonly="readonly" />
                                    </div>
                                    <div class="form-group">
                                        <label class="small mb-1" for="inputJudul">Judul Buku</label>
                                        <input class="form-control py-4" id="inputJudul" name="judul" type="text" value="<?php echo $edit['judul'] ?>" placeholder="Ketik judul buku" />
                                    </div>
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select style="overflow: scroll;" class="form-control" id="inputPenerbit" name="penerbit" >
                                                    ...
                                                    while ($data= mysqli_fetch_assoc($penerbit)) {
                                                        ...
                                                        if ($data['id_penerbit'] == $edit['id_penerbit']) {
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select style="overflow: scroll;" class="form-control" id="inputPenulis" name="penulis">
                                                    ...
                                                    while ($data= mysqli_fetch_assoc($penulis)) {
                                                        ...
                                                        if ($data['id_penulis'] == $edit['id_penulis']) {

                                                            echo "<option value=".$data['id_penulis']." selected>".$data['penulis']."</option>";
                                                        }
                                                        else {
                                        ...
                                        <label class="small mb-1" for="inputKategori">Kategori</label>
                                            <select style="overflow: scroll;" class="form-control" id="inputKategori" name="kategori">
                                                ...
                                                while ($data= mysqli_fetch_assoc($kategori)) {
                                                    ...
                                                    if ($data['id_kategori'] == $edit['id_kategori']) {
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control py-4" id="inputHalaman" name="halaman" type="number" value="<?php echo $edit['halaman'] ?>" placeholder="Ketik jumlah halaman buku" />
                                    </div>
                                    <div class="form-group">
                                        <label class="small mb-1" for="inputStok">Stok</label>
                                        <input class="form-control py-4" id="inputStok" name="stok" type="number" value="<?php echo $edit['stok'] ?>" placeholder="Ketik jumlah stok buku" />
                                    </div>   
                                    <div class="form-group">
                                        <label class="small mb-1" for="inputTahunTerbit">Tahun Terbit</label>
                                        <input class="form-control py-4" id="inputTahunTerbit" name="tahun_terbit" type="text" value="<?php echo $edit['tahun_terbit'] ?>" placeholder="yyyy" maxlength="4"/>
                                    </div>   
