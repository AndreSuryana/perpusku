        ...
        if (empty($_POST['isbn_buku']) || empty($_POST['judul']) || empty($_POST['kategori']) || empty($_POST['halaman']) ||
            ...
            ?> 
                <script type="text/javascript">
                    ...
                    window.location = '../../views/pegawai/kelola-data-buku.php';
                </script>
            <?php
            ...
            $sql = "CALL editBuku('$isbn_buku', '$judul', $penerbit, $penulis, $kategori, $halaman, $stok, '$tahun_terbit')";
            ...
            if ($query_insert) {
                ...
                ?> 
                    <script type="text/javascript">
                        confirm('Edit Data Buku Berhasil');
                        window.location = '../../views/pegawai/kelola-data-buku.php';
                    </script>
                <?php
            }
                ...
                ?> 
                    <script type="text/javascript">
                        confirm('Edit Data Buku Gagal! Silahkan ulangi lagi!');
                        window.location = '../../views/pegawai/kelola-data-buku.php';
                    </script>
                <?php
            }
